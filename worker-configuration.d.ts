...
declare namespace Cloudflare {
	...
	interface Env {
		...
		USE_SUPABASE_AUTH: string;
		SUPABASE_URL: string;
		SUPABASE_ANON_KEY: string;
		SUPABASE_JWT_SECRET: string;
		SUPABASE_OAUTH_GOOGLE: string;
		SUPABASE_OAUTH_GITHUB: string;
